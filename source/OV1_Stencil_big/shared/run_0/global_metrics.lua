_report = {
  metrics = {
    ...
    loops_time = 55.05,
    speedup_if_fp_vect = 1.1009,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 7.7088215007786,
    ...
    speedup_if_fully_vectorised = 1.4772,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.2242,
    profiled_time = 55.39,
    array_access_efficiency = "Not Available",
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.4293,
    nb_threads = 16,
    application_time = 61.164661407471,
    compilation_options = 25,
    innerloops_time = 54.75,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 30.49 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 30.33 seconds.",
  },
  colors = {
